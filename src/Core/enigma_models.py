...
ENIGMA_MODELS = {
    ...
    #  also known as the Wehrmacht, or "Services" Enigma, and was used
    #  extensively by German military services and other government
    #  organisations (such as the railways) before and during World War II.
    'Enigma1' : EnigmaModel('Enigma Model 1', 'Enigma1',
                            RotorCount.ThreeRotors, True),

    ## Enigma A, also known as Die kleine Militärmaschine (the small military
    #  machine), was an electro­mechanical rotor-based cipher machine,
    #  introduced in 1924 by Chiffriermaschinen Aktien­gesell­schaft (ChiMaAG)
    #  in Berlin (Germany). It was the first Enigma that used light bulbs for
    #  its output.
    ...
    'M4' : EnigmaModel('German Navy 4-rotor M4 Enigma', 'M4',
